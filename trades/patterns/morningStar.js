const { isDojiStar, isUptrend, isDowntrend } = require("../algorithms/klines");
...
const detectMorningStarPattern = (candles) =>
  candles.slice(-3).reduce(
    ([prevCandle, currentCandle, isMorningStarPattern], nextCandle) => {
